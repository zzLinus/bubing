...
/* Private defines -----------------------------------------------------------*/
#define BUTTON_TRIG_Pin LL_GPIO_PIN_7
#define BUTTON_TRIG_GPIO_Port GPIOI
#define RSTN_IST8310_Pin LL_GPIO_PIN_6
#define RSTN_IST8310_GPIO_Port GPIOG
#define LED_R_Pin LL_GPIO_PIN_12
#define LED_R_GPIO_Port GPIOH
#define DRDY_IST8310_Pin LL_GPIO_PIN_3
#define DRDY_IST8310_GPIO_Port GPIOG
#define DRDY_IST8310_EXTI_IRQn EXTI3_IRQn
#define ADC_BAT_Pin LL_GPIO_PIN_10
#define ADC_BAT_GPIO_Port GPIOF
#define LED_G_Pin LL_GPIO_PIN_11
#define LED_G_GPIO_Port GPIOH
#define LED_B_Pin LL_GPIO_PIN_10
#define LED_B_GPIO_Port GPIOH
#define HW0_Pin LL_GPIO_PIN_0
#define HW0_GPIO_Port GPIOC
#define HW1_Pin LL_GPIO_PIN_1
#define HW1_GPIO_Port GPIOC
#define HW2_Pin LL_GPIO_PIN_2
